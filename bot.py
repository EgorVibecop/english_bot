...
# Уровни по шкале CEFR — разметка взята из списка Oxford 3000/5000, где
# каждое слово помечено уровнем. Раньше деление на три уровня было моей
# оценкой сложности на глаз, теперь это внешний стандарт.
LEVELS = {
    1: "A1 — начальный (719 слов)",
    2: "A2 — элементарный (492 слова)",
    3: "B1 — средний (342 слова)",
    4: "B2 — выше среднего (242 слова)",
    5: "C1 — продвинутый (118 слов)",
    6: "C2 — свободный (222 слова)",
}
